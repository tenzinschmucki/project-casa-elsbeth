...
## Deployment candidate note

This folder is the safe deployment-prep copy.

If you want to publish this version through GitLab, Netlify, and Render, start here:

- `DEPLOY_GITLAB_NETLIFY_RENDER.md`
